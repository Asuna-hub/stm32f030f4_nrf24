...
void SPI_DMA_transfer_data(uint8_t *tx_data, uint8_t *rx_data, uint16_t size){
	DMA1->IFCR = DMA_IFCR_CTCIF3 | DMA_IFCR_CTCIF2 | DMA_IFCR_CHTIF3 | DMA_IFCR_CHTIF2 | DMA_IFCR_CTEIF3 | DMA_IFCR_CTEIF2;
...
void SPI_DMA_TX(uint8_t *tx_data, uint16_t size){
	...
	DMA1_Channel2->CPAR = (uint32_t)&SPI1->DR;
	DMA1_Channel2->CMAR = (uint32_t)tx_data;
	DMA1_Channel2->CNDTR = size;
